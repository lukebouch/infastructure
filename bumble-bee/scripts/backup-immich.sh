...
duplicity backup --no-encryption library "${b2_url}/apps/immich/library"

echo "Backing up upload directory..."
duplicity backup --no-encryption upload "${b2_url}/apps/immich/upload"

echo "Backing up profile directory..."
duplicity backup --no-encryption profile "${b2_url}/apps/immich/profile"
